...
export class Bestsellers extends SkeletSect {
  ...
  createCardCarcass() {
    ...
    cardLikeBtn.setHtml(`<svg width="35" height="33" viewBox="0 0 35 33" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return [card, cardImg, cardWrapper, cardTitle, cardDescr, cardPriceWrapper, cardPrice, cardLikeBtn, cardBtn];
  }
  ...
  getBestsellersCard(bestsellersCardInfo) {
    ...
    bestsellersCardInfo.forEach((cardInfo) => {
      let [card, cardImg, cardWrapper, cardTitle, cardDescr, 
        cardPriceWrapper, cardPrice, cardLikeBtn, cardBtn] = this.createCardCarcass();
      ...
      card.insertItems([cardImg, cardTitle, cardDescr, cardPriceWrapper, cardBtn]);
